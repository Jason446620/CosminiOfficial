...
{
    public partial class CosminisContext : DbContext
    {
        public CosminisContext()
        {
        }

        public CosminisContext(DbContextOptions<CosminisContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                entity.HasOne(d => d.PostFkNavigation)
                    ...
                    .HasConstraintName("FK__comments__post_f__58D1301D");

                entity.HasOne(d => d.UserFkNavigation)
                    .WithMany(p => p.Comments)
                    .HasForeignKey(d => d.UserFk)
                    .HasConstraintName("FK__comments__user_f__57DD0BE4");
            });
            ...
            modelBuilder.Entity<Companion>(entity =>
            {
                ...
                entity.HasOne(d => d.EmotionNavigation)
                    ...
                    .HasConstraintName("FK__companion__emoti__245D67DE");

                entity.HasOne(d => d.SpeciesFkNavigation)
                    .WithMany(p => p.Companions)
                    .HasForeignKey(d => d.SpeciesFk)
                    .HasConstraintName("FK__companion__speci__236943A5");

                entity.HasOne(d => d.UserFkNavigation)
                    .WithMany(p => p.Companions)
                    .HasForeignKey(d => d.UserFk)
                    .HasConstraintName("FK__companion__user___22751F6C");
            });
            ...
            modelBuilder.Entity<Conversation>(entity =>
            {
                ...
                entity.HasOne(d => d.SpeciesFkNavigation)
                    ...
                    .HasForeignKey(d => d.SpeciesFk)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__conversat__speci__2EDAF651");
            });
            ...
            modelBuilder.Entity<EmotionChart>(entity =>
            {
                entity.HasKey(e => e.EmotionId)
                    .HasName("PK__emotionC__F10B8722CAC12B96");
            ...
            modelBuilder.Entity<FoodInventory>(entity =>
            {
                entity.HasKey(e => new { e.UserFk, e.FoodStatsFk })
                    .HasName("PK__foodInve__CB0B947DF68BAFF9");
                ...
                entity.HasOne(d => d.FoodStatsFkNavigation)
                    ...
                    .HasConstraintName("FK__foodInven__foodS__40058253");

                entity.HasOne(d => d.UserFkNavigation)
                    .WithMany(p => p.FoodInventories)
                    .HasForeignKey(d => d.UserFk)
                    .HasConstraintName("FK__foodInven__user___3F115E1A");
            });

            modelBuilder.Entity<FoodStat>(entity =>
            {
                entity.HasKey(e => e.FoodStatsId)
                    .HasName("PK__foodStat__0E4BD16B92563DF5");
                ...
                entity.HasOne(d => d.FoodElementFkNavigation)
                    ...
                    .HasConstraintName("FK__foodStats__foodE__3C34F16F");
            });
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasOne(d => d.UserFkNavigation)
                    .WithMany(p => p.Orders)
                    .HasForeignKey(d => d.UserFk)
                    .HasConstraintName("FK__orders__user_fk__5BAD9CC8");
            });
            ...
            modelBuilder.Entity<Post>(entity =>
            {
                ...
                entity.HasOne(d => d.UserFkNavigation)
                    .WithMany(p => p.Posts)
                    .HasForeignKey(d => d.UserFk)
                    .HasConstraintName("FK__posts__user_fk__489AC854");
            });
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasIndex(e => e.Username, "UQ__users__F3DBC572A1359B6C")
                    .IsUnique();
                ...
                entity.HasOne(d => d.ShowcaseCompanionFkNavigation)
                    ...
                    .HasConstraintName("FK__users__showcaseC__6442E2C9");

                entity.HasMany(d => d.PostFks)
                    .WithMany(p => p.UserFks)
                    .UsingEntity<Dictionary<string, object>>(
                        "Like",
                        l => l.HasOne<Post>().WithMany().HasForeignKey("PostFk").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__likes__post_fk__503BEA1C"),
                        r => r.HasOne<User>().WithMany().HasForeignKey("UserFk").HasConstraintName("FK__likes__user_fk__4F47C5E3"),
                        j =>
                        {
                            j.HasKey("UserFk", "PostFk").HasName("PK__likes__1A5355BF2C25CD7C");
